package com.eeducationgo.tectik.ui;
...
public class BookingFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Confirm Booking");
    ...
    private void linkUi(View root) {
        ...
        confirm = root.findViewById(R.id.button_confirm_booking);
